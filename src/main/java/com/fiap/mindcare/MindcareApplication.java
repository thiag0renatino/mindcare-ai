...
public class MindcareApplication {
    ...
    @Bean
    @Profile("!test")
    CommandLineRunner bootstrapAdminRunner(UsuarioSistemaRepository usuarioSistemaRepository,
                                           EmpresaRepository empresaRepository,
                                           PasswordEncoder passwordEncoder,
                                           @Value("${app.bootstrap-admin.enabled:true}") boolean bootstrapAdminEnabled) {
        return args -> {
